const industries = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7">
        <path d="M12 22V12m0 0L8 8m4 4l4-4M6 20.5A8.38 8.38 0 002 12C2 6.477 6.477 2 12 2s10 4.477 10 10a8.38 8.38 0 01-4 8.5" />
      </svg>
    ),
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-12">
          ...
          <p className="text-slate-500 text-sm max-w-xs sm:text-right leading-relaxed">
            Supplying material handling and lifting equipment across a wide range of industrial sectors.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          {industries.map((ind) => (
            ...
            >
              <span className="text-[#1e3a5f] group-hover:text-amber-600 transition-colors flex justify-center mb-3">
                {ind.icon}
              </span>
